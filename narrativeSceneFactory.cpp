...
NarrativeSceneFactory::NarrativeSceneFactory() {
    ...
    new NarrativeScene({
        ...
        new TextNode(paddy, "If you're not up for this, you're always free to leave and come back another day.", TEXT_DIALOGUE),
    ...
    new NarrativeScene({
        ...
        new TextNode(player, "A-Ahhh, t-that person's h-head i-is…", TEXT_DIALOGUE),
        new AddCharacterNode(paddy),
    ...
    new NarrativeScene({
        ...
        new TextNode(dullahan, "Average...Interesting...You seem to have gotten over headless soldiers quicker than most.", TEXT_DIALOGUE),
        ...
        new ChoiceNode(dullahan, "Crom isn't worried about my outburst. What should I do?",
            ...
            "Ask to hold her head.",
            {
                ...
                new TextNode(player, "Paddy, my saviour I have failed thee.", TEXT_MONOLOGUE),
