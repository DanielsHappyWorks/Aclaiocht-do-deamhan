...
SoundManager::SoundManager() {
    ...
    sounds = {
        {SFX_WALK, LoadSound("./assets/sounds/freesound/362777__taure__walking_wood.wav")},
        {SFX_SWIPE, LoadSound("./assets/sounds/freesound/398404__caitlin_100__swipescrape.mp3")},
